  ...
  return (
    <section id="precios" className="px-6 py-20 lg:px-8 lg:py-32">
      <div className="mx-auto max-w-4xl">
        <motion.div
          className="relative overflow-hidden rounded-3xl border border-accent/30 bg-accent/10 px-8 py-16 text-center sm:px-16"
        ...
        >
          ...
          <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
            <span className="text-balance">Transforma tu Atencion al Cliente Hoy</span>
          </h2>
