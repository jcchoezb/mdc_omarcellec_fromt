      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              Soluciones tecnologicas con sentido humano para transformar tu negocio.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col space-y-3">
              <a
                href="mailto:proyectos@omarcellec.com"
                className="flex items-center gap-2 text-sm text-gray-400 transition-colors hover:text-primary"
              >
                <Mail className="h-4 w-4 shrink-0" />
                <span className="break-all">proyectos@omarcellec.com</span>
              </a>
              <a
                href="https://wa.me/593980383699"
                target="_blank"
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.instagram.com/omarcellec" target="_blank" rel="noopener noreferrer" className="text-gray-400 transition-colors hover:text-pink-500">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-gray-700 pt-8 sm:flex-row">
          <p className="text-sm text-gray-400">
            &copy; 2026 Omarcellec. Todos los derechos reservados.
          </p>
