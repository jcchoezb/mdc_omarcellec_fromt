          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex items-center gap-4 text-sm">
              ...
              >
                ...
                <span>proyectos@omarcellec.com</span>
              </a>
              <a 
                href="https://wa.me/593980383699" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-muted-foreground transition-colors hover:text-[#25D366]"
              >
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              <a href="#" className="text-muted-foreground transition-colors hover:text-secondary">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
